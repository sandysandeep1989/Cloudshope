    ...
    new Chart(o, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: "rgba(129,222,118,.7)",
                ...
                backgroundColor: "rgba(247,187,29,.8)",
                borderColor: "transparent",
                pointBorderColor: "#FF5A78",
                pointBackgroundColor: "#FFF",
                pointBorderWidth: 2,
                pointHoverBorderWidth: 2,
                pointRadius: 4
                ...
                label: " Calls",
                data: [0, 90, 110, 340, 140, 165, 170],
                backgroundColor: "rgba(97,170,236,0.8)",
                borderColor: "transparent",
                pointBorderColor: "#F1BB1D",
                pointBackgroundColor: "#FFF",
                pointBorderWidth: 2,
                pointHoverBorderWidth: 2,
                pointRadius: 4
                ...
                label: " Lead Closed",
                data: [10, 10, 120, 40, 140, 280, 190],
                backgroundColor: "rgba(244,104,121,0.7)",
                borderColor: "transparent",
                pointBorderColor: "#F46879",
                pointBackgroundColor: "#FFF",
                pointBorderWidth: 2,
                pointHoverBorderWidth: 2,
                pointRadius: 4
